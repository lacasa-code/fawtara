...
Route::group(['prefix'=>'customer'],function()
{
	...
	Route::get('/car/update/{id}',['as'=>'customer/car/update/{id}','uses'=>'Customercontroller@car_update']);
...
Route::group(['prefix'=>'service'],function()
{
    ...
    Route::post('add_reportcard','ServicesControler@add_reportcard')->middleware('can:service_add');
    Route::post('add_report','ServicesControler@add_reportcard')->middleware('can:report_add');

  	Route::get('list/view',['as'=>'service/list/view','uses'=>'ServicesControler@serviceview']);
  	Route::get('get_vehi_name',['as'=>'service/add','uses'=>'ServicesControler@get_vehicle_name2']);
...
Route::group(['prefix'=>'invoice'],function()
{
	...
	Route::get('/reports/final','ManualInvoiceController@filter_dateRange')->name('CountFinal');
	Route::get('/reports/{from}/{to}', 'ManualInvoiceController@filter_dateRange');
	...
	Route::get('/show/inv/{id}','InvoiceController@showInvoice2')->middleware('can:invoice_view')->name('showInvoice2edit');
	Route::get('/show/inv/{id}','InvoiceController@showInvoice2')->middleware('can:invoice_view')->name('showInvoice2edit');
	Route::get('/addInvoice','AInvoiceController@addInvoice')->middleware('can:invoice_add');
	Route::post('/invoiceStore','AInvoiceController@store2')->middleware('can:invoice_add');
	...
	/* ######################################################################################### */
	Route::get('/electronic/invoice','ElectronicInvoiceController@viewCustomers')->middleware('can:invoice_view');
	Route::get('/jobcards/{id}','ElectronicInvoiceController@customer_jobcards')->middleware('can:invoice_view');
	Route::get('/electronic/jobcard/add/{id}','ElectronicInvoiceController@add_invoice')->middleware('can:invoice_view');
...
// custom 
	...
	Route::get('/edit/{id}','ManualInvoiceController@ManualEdit')->middleware('can:invoice_view')
	    ->name('ManualEdit');
	Route::post('/edit/manual/invoice','ManualInvoiceController@UpdateInvoice2')->middleware('can:invoice_add');

	Route::get('/invoiced/{id}','ManualInvoiceController@ManualInvoiced')->middleware('can:invoice_add')
	->name('ManualInvoiced');

	Route::get('/preview/{id}','ManualInvoiceController@preview')->middleware('can:invoice_add')
	->name('preview');

	//Route::get('/saad','ManualInvoiceController@saad')->middleware('can:invoice_add')
	//->name('saad');
	...
	Route::get('/listall/{from}/{to}', 'ManualInvoiceController@PendingDaterange')->name('PendingDaterange');
	...
	Route::get('/scan/{inv_number}/{inv_branch}/{inv_vatno}/{inv_date}/{inv_total}/{inv_15_value}','ManualInvoiceController@scanInvoice')->name('showInvoice3');

	Route::get('/scan/pdf/{id}','ManualInvoiceController@scanInvoicepdf')->name('showInvoicepdf');
...
{
    Route::get('/list',['as'=>'listengineer','uses'=>'Engineerstaffcontroller@index'])->middleware('can:engineer_view');
    Route::get('/list/{id}',['as'=>'engineer/list/{id}','uses'=>'Engineerstaffcontroller@supportstaff_show'])->middleware('can:engineer_view');
    Route::get('/add',['as'=>'engineer','uses'=>'Engineerstaffcontroller@supportstaffadd'])->middleware('can:engineer_add');
    Route::post('/store',['as'=>'engineer','uses'=>'Engineerstaffcontroller@store_supportstaff'])->middleware('can:engineer_add');
    Route::get('list/edit/{id}',['as'=>'engineer','uses'=>'Engineerstaffcontroller@edit']);
    Route::post('/list/edit/update/{id}',['as'=>'engineer/list/edit/update/{id}','uses'=>'Engineerstaffcontroller@update']);
    Route::get('/list/delete/{id}',['as'=>'/engineer/list/delete/{id}','uses'=>'Engineerstaffcontroller@destory'])->middleware('can:engineer_delete');
});
//Product List Module
...
/*reportcar*/
Route::group(['prefix'=>'reportcar'],function()
{
    Route::get('list',['as'=>'reportcar/list','uses'=>'ReportcarControler@index'])->middleware('can:reportcar_view');
    Route::get('/list/{id}',['as'=>'reportcar','uses'=>'ReportcarControler@view'])->middleware('can:reportcar_view');/*Display ProcessJob Form(If click on ProcessJob Button on Listing Page)*/
    Route::post('/store',['as'=>'reportcar/store','uses'=>'ReportcarControler@store'])->middleware('can:reportcar_edit');/*Store ProcessJob data*/
