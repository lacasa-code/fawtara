...
Route::group(['prefix'=>'customer'],function()
{
	...
	Route::get('/car/update/{id}',['as'=>'customer/car/update/{id}','uses'=>'Customercontroller@car_update'])->middleware('can:customer_update');
...
// custom 
	...
	Route::get('/manual/invoice/customer/{id}','ManualInvoiceController@customer_invoice')->middleware('can:invoice_view');
