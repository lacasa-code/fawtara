...
class SupportstaffAddEditFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'employeeid'=> 'required|min:6|max:16|regex:/^[- +()]*[0-9][- +()0-9]*$/',
            'join_date' => 'required',
            //'dob' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            //
            'employeeid.required' => trans('app.employeeid is required.'),
            'employeeid.unique' => trans('app.employeeid you entered is already registered.'),
            //
