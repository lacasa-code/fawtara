...
class ManualInvoiceController extends Controller
{
    ...
    public function getInvoice2()
	{
		...
		if(!empty($last_order)){
			...
			$new_number='#'.$auth_branch_id.'-'.$new_number1;
		}else{
			$new_number = '00000001';
		}
		...
		return view('Manual.getInvoiceNov2', compact('code', 'codepay', 'tbl_payments', 'branches', 'currentUser', 'branchDatas', 'customers', 'tax', 'auth_branch_vat_number', 'auth_branch'));
	}
