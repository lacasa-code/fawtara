...
class VehicalControler extends Controller
{
	...
	public function index()
	{
		...
		$customers = User::where('soft_delete', 0)->where('role', 'Customer')->orderBy('id','DESC')->get();

		return view ('vehicle.add',compact('vehical_type','vehical_brand','fuel_type','color','model_name','tbl_custom_fields', 'branchDatas', 'customers'));
	}
