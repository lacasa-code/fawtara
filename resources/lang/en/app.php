...
return[
    ...
    'Engineer List' => 'Supportstaff List',
 ...
 //Vehical Brands
  ...
  // VehicalDiscriptions List
   ...
   'KMS Run'=>'KMS Run',
    'FLTP'=>'Front left tire pressure',
    'FRTP'=>'Front right tire pressure',
    'RRTP'=>'Rear Right tire pressure',
    'RLTP'=>'Rear Left tire pressure',
   ...
   //stoke
    ...
    'Step - 2 : Add Report Details...'=>'Step - 2 : Add Report Details...',
    ...
    //engineers list page
    "engineers" => "Foreman",
    "engineers_staff"=> "Foreman Staffs ",
    "engineer_List"=>"Foreman List",
    "engineer_add"=>"Add Foreman",
    "engineer_edit"=>"Edit Foreman",
    "engineer_view"=>"View Foreman",
    "reportcar"=>"Report Car",
    "reportcar_List"=>"Report Car List",
    "reportcar_No"=>"Report  No",
    "quotation_No"=>"Report  No",
