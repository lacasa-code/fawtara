					...
					<nav>
						<div class="nav toggle">
							<a id="menu_toggle">
								...
								<span class="titleup">&nbsp; {{ trans('app.Branch Admin')}}</span>
							</a>
						</div>
		...
		<div class="x_content">
            <ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
				...
				@can('supportstaff_add')
					<li role="presentation" class="active setTabAddSupportStaffOnSmallDevice"><a href="{!! url('/branchadmin/add')!!}"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i> <b>{{ trans('app.Add Branch Admin') }}</b></a></li>
				@endcan
			</ul>
		</div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					<div class="x_content">
						<form id="branchAdmin_add_form" action="{!! url('/branchadmin/store')!!}" method="post"
