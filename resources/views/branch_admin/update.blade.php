        ...
        <div class="x_content">
            <ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
              @can('branchAdmin_view')
                <li role="presentation" class=""><a href="{!! url('/branchadmin/list')!!}"><span class="visible-xs"></span><i class="fa fa-list fa-lg">&nbsp;</i> {{ trans('app.Branch Admin List') }}</a></li>
              @endcan
              @can('branchAdmin_edit')
                <li role="presentation" class="active"><a href="{!! url('/branchadmin/list/edit/'.$branchadmin->id)!!}"><span class="visible-xs"></span><i class="fa fa-pencil-square-o" aria-hidden="true">&nbsp;</i> <b>{{ trans('app.Edit Branch Admin')}}</b></a></li>
              @endcan

              @if(getUserRoleFromUserTable(Auth::User()->id) == 'branch_admin')
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                   <div class="x_content">
                    <form id="supportstaff_edit_form" action="update/{{ $branchadmin->id }}" method="post"
                       ...
                       <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('firstname') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" id="firstname" name="firstname" placeholder="{{ trans('app.Enter First Name')}}" value="{{$branchadmin->name}}" class="form-control" maxlength="50">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('lastname') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" id="lastname"  name="lastname" placeholder="{{ trans('app.Enter Last Name')}}" maxlength="50" value="{{$branchadmin->lastname}}" class="form-control">
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text"  name="displayname" id="displayname" placeholder="{{ trans('app.Enter Display Name')}}" value="{{$branchadmin->display_name}}" maxlength="25" class="form-control ">
                        </div>
                      </div>
                       <div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12 gender">
                              ...
                              <input type="radio"  name="gender" value="0"  <?php if($branchadmin->gender ==0) { echo "checked"; }?> checked>  {{ trans('app.Male')}}

                              <input type="radio" name="gender" value="1" <?php if($branchadmin->gender ==1) { echo "checked"; }?>> {{ trans('app.Female')}}
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-6 col-xs-12">
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group {{ $errors->has('dob') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12 input-group date datepicker">
                          ...
                          @if($branchadmin->birth_date)
                            <input type="text" id="date_of_birth" autocomplete="off" class="form-control" placeholder="<?php echo getDateFormat();?>" value="{{date(getDateFormat(),strtotime($branchadmin->birth_date))}}" name="dob" onkeypress="return false;" />
                          @else
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text"  name="email" placeholder="{{ trans('app.Enter Email')}}" value="{{$branchadmin->email}}" class="form-control" maxlength="50" >
                  ...
                  <div class="col-md-12 col-sm-6 col-xs-12">
                     <div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('mobile') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text"  name="mobile" placeholder="{{ trans('app.Enter Mobile No')}}" value="{{$branchadmin->mobile_no}}" maxlength="16" minlength="6"  class="form-control" required>
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('landlineno') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text" id="landlineno" name="landlineno" placeholder="{{ trans('app.Enter LandLine No')}}" value="{{$branchadmin->landline_no}}" maxlength="16" minlength="6" class="form-control">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <select class="form-control col-md-7 col-xs-12 select_branch" name="branch">
                            @foreach ($branchDatas as $branchData)
                              <option value="{{ $branchData->id }}" <?php if($branchadmin->branch_id==$branchData->id){ echo "selected"; }?>>{{$branchData->branch_name }}</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
                        ...
                        <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group {{ $errors->has('join_date') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12 input-group date datepicker">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                    <input type="text" id="join_date" class="form-control leftdate joinDate" placeholder="<?php echo getDatepicker();?>"  value="{{date(getDateFormat(),strtotime($branchadmin->join_date))}}"   name="join_date" readonly>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('employeeid') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <input type="text" id="employeeid" name="employeeid"  value="{{$branchadmin->employeeid }}" placeholder="{{ trans('app.Enter Employee ID')}}" class="form-control"  maxlength="16" minlength="6">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <select class="form-control  select_country" name="country_id" countryurl="{!! url('/getstatefromcountry') !!}">
                            <option value="">Select Country</option>
                                ...
                                <option value="{{ $countrys->id }}" <?php if($branchadmin->country_id==$countrys->id){ echo "selected"; }?>>{{$countrys->name }}</option>
                                @endforeach
                          </select>
                        </div>
                      </div>
                         ...
                         <div class="col-md-8 col-sm-8 col-xs-12">
                          ...
                          @if($state != null)
                            @foreach ($state as $states)
                                <option value="{!! $states->id !!}" <?php if($branchadmin->state_id==$states->id){ echo "selected"; }?>>{!! $states->name !!}</option>
                              @endforeach
                          @else
                            <option value=""></option>
                          @endif
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        @if($city != null)
                          @foreach ($city as $citys)
                            <option value="{!! $citys->id !!}" <?php if($branchadmin->city_id==$citys->id){ echo "selected"; }?>>{!! $citys->name !!}</option>
                          @endforeach
                        @else
                          <option value=""></option>
                        @endif
