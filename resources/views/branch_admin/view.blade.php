            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_content">
					<ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
						...
						@endcan
						@can('branchAdmin_view')
							<li role="presentation" class="active"><a href="{!! url('/branchadmin/list/'.$viewid)!!}"><span class="visible-xs"></span><i class="fa fa-user">&nbsp; </i> <b> {{ trans('app.View Branch Admin') }}</b></a></li>
						@endcan
					</ul>
			    </div>
					...
					<div class="col-md-8 col-sm-12 col-xs-12 main_left">
                      ...
                      <!-- title row -->
					        <div class="col-md-6 col-sm-12 col-xs-12 left_side">
								<img src="{{ URL::asset('public/branch_admin/'.$branchadmin->image) }}" class="cimg" >
						    </div>
						    <div class="col-md-6 col-sm-12 col-xs-12 right_side">
								...
								<div class="table_row">
									...
									<div class="col-md-7 col-sm-12 table_td">
										<span class="txt_color">{{ $branchadmin->email }}</span>
									</div>
								</div>
                                <div class="table_row">
                                    <div class="col-md-5 col-sm-12 col-xs-12 table_td">
                                        <i class="fa fa-credit-card"></i>
                                        <b>{{trans('app.EmployeeId')}}</b>
                                    </div>
                                    <div class="col-md-7 col-sm-12 col-xs-12 table_td">

                                        <span class="txt_color">{{$branchadmin->employeeid}}</span>
                                    </div>
                                </div>
								<div class="table_row">
									...
									<div class="col-md-7 col-sm-12 table_td">
										<span class="txt_color">
											<span class="txt_color">{{ $branchadmin->mobile_no }} </span>
										</span>
									</div>
								</div>
								<div class="table_row">
								...
								<div class="table_row">
									...
									<div class="col-md-7 col-sm-12 table_td">
										<span class="txt_color">
										  {{ $branchadmin->address }},<br/>
										  <?php echo (getCityName($branchadmin->city_id) != null) ? getCityName($branchadmin->city_id) .",<br>" : "";?>
										  {{ getStateName($branchadmin->state_id)}}, {{ getCountryName($branchadmin->country_id)}}.
										</span>
									</div>
								</div>
							</div>
