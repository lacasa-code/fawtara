            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_content">
					<ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
						...
						@endcan
						@can('engineer_view')
							<li role="presentation" class="active"><a href="{!! url('/engineer/list/'.$viewid)!!}"><span class="visible-xs"></span><i class="fa fa-user">&nbsp; </i> <b> {{ trans('app.engineer_view') }}</b></a></li>
						@endcan
					</ul>
			    </div>
					...
					<div class="col-md-8 col-sm-12 col-xs-12 main_left">
                      ...
                      <!-- title row -->
					        <div class="col-md-6 col-sm-12 col-xs-12 left_side">
								<img src="{{ URL::asset('public/engineer/'.$supportstaff->image) }}" class="cimg" >
						    </div>
						    <div class="col-md-6 col-sm-12 col-xs-12 right_side">
                                ...
                                <div class="table_row">
                                    ...
                                    <div class="col-md-7 col-sm-12 col-xs-12 table_td">
                                        ...
                                        <span class="txt_color">{{$supportstaff->employeeid}}</span>
                                    </div>
                                </div>
								<div class="table_row">
