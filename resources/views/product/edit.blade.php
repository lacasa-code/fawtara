                              	...
                              	<div class="col-md-4 col-sm-4 col-xs-12">
                                	<select class="form-control  select_branch" name="branch">
                                  	@foreach ($branchDatas as $branchData)
										<option value="{{ $branchData->id }}" <?php if($product->branch_id==$branchData->id){ echo "selected"; }?>>{{$branchData->branch_name }}</option>
									@endforeach
                                	</select>
                              	</div>
                            </div>						
					...
					<!-- Custom Filed data value End-->
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                          ...
                          <button type="submit" class="btn btn-success updateProductButton">{{ trans('app.Update')}}</button>
                        </div>
                      </div>
                    </form>
                </div>
