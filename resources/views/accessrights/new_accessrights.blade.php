			...
			<div class="x_content">
				...
				<!-- New Access Rights Ending -->
					...
					@can('branchsetting_view')
						<li role="presentation" class="suppo_llng_li_add floattab"><a href="{!! url('branch_setting/list')!!}" class="anchor_tag anchr"><span class="visible-xs"></span><i class="fa fa-university">&nbsp;</i>{{ trans('app.Branch Setting')}}</a></li>
					@endcan
				</ul>
			</div>
							...
							<div class="panel panel-default">
									...
									<h4 class="panel-title" style="padding: 10px;">
										<a data-toggle="collapse" href="#collapse{{$get_right->id}}" class="makePlusMinus{{$get_right->id}}" style="color:#5A738E">
											...
											@elseif($get_right->role_name == "Branch Admin")
												{{ trans('app.Branch Admin') }}
                                            @elseif($get_right->role_name == "Engineer")
                                                {{ trans('app.Engineer') }}
								...
								<form name="" id="" method="post" action="{{ url('setting/accessrights/access_store',$get_right->id)}}" enctype="multipart/form-data">
									...
									<table id="datatable" class="table table-striped table-bordered jambo_table">
                                        ...
                                        <!-- Engineer Access Rights Start -->
                                        <tr>
                                            <td>{{ trans('app.Engineer')}}</td>
                                            <td class="">
                                                <input type="checkbox" data-row="{{$i}}" class="main_access" data-for="engineer" name="engineer[]" value="engineer_view"
                                                @if(!empty($regex->engineer_view))
                                                    @if($regex->engineer_view == TRUE) {{'checked'}} @endif
                                                    @endif
                                                >
                                            </td>
                                            <td>
                                                <input type="checkbox" class="engineer_{{$i}}" name="engineer[]" value="engineer_add"
                                                @if(!empty($regex->engineer_add))
                                                    @if($regex->engineer_add == TRUE) {{'checked'}} @endif
                                                    @endif
                                                >
                                            </td>
                                            <td>
                                                <input type="checkbox" class="engineer_{{$i}}" name="engineer[]" value="engineer_edit"
                                                @if(!empty($regex->engineer_edit))
                                                    @if($regex->engineer_edit == TRUE) {{'checked'}} @endif
                                                    @endif
                                                >
                                            </td>
                                            <td>
                                                <input type="checkbox" class="engineer_{{$i}}" name="engineer[]" value="engineer_delete"
                                                @if(!empty($regex->engineer_delete))
                                                    @if($regex->engineer_delete == TRUE) {{'checked'}} @endif
                                                    @endif
                                                >
                                            </td>
                                            <td>
                                                @if($get_right->role_name == "Engineer")
                                                    <input type="checkbox" class="employee_{{$i}}" name="engineer[]" value="engineer_owndata"
                                                    @if(!empty($regex->engineer_owndata))
                                                        @if($regex->engineer_owndata == TRUE) {{'checked'}} @endif
                                                        @endif
                                                    >
                                                @endif
                                        ...
                                        <!-- Report Access Rights Start -->
                                        <tr>
                                            <td>{{ trans('app.reportcar')}}</td>
                                            <td class="">
                                                <input type="checkbox" data-row="{{$i}}" class="main_access" data-for="reportcar" name="reportcar[]" value="reportcar_view"
                                                @if(!empty($regex->reportcar_view))
                                                    @if($regex->reportcar_view == TRUE) {{'checked'}} @endif
                                                    @endif
                                                >
                                            </td>
                                            <td>
                                                <input type="checkbox" class="reportcar_{{$i}}" name="reportcar[]" value="reportcar_add"
                                                @if(!empty($regex->reportcar_add))
                                                    @if($regex->reportcar_add == TRUE) {{'checked'}} @endif
                                                    @endif
                                                >
                                            </td>
                                            <td>
                                                <input type="checkbox" class="reportcar_{{$i}}" name="reportcar[]" value="reportcar_edit"
                                                @if(!empty($regex->reportcar_edit))
                                                    @if($regex->reportcar_edit == TRUE) {{'checked'}} @endif
                                                    @endif
                                                >
                                            </td>
                                            <td>
                                                <input type="checkbox" class="reportcar_{{$i}}" name="reportcar[]" value="reportcar_delete"
                                                @if(!empty($regex->reportcar_delete))
                                                    @if($regex->reportcar_delete == TRUE) {{'checked'}} @endif
                                                    @endif
                                                >
                                            </td>
										...
										<!-- Branch Module Access Rights Start -->
											<tr>
												<td>{{ trans('app.Branch')}}</td>
												<td class="">
													<input type="checkbox" data-row="{{$i}}" class="main_access" data-for="branch" name="branch[]" value="branch_view"
													@if(!empty($regex->branch_view))
													@if($regex->branch_view == TRUE) {{'checked'}} @endif
													@endif
													>
												</td>
												<td>
													<input type="checkbox" class="branch_{{$i}}" name="branch[]" value="branch_add"
													@if(!empty($regex->branch_add))
													@if($regex->branch_add == TRUE) {{'checked'}} @endif
													@endif
													>
												</td>
												<td>
													<input type="checkbox" class="branch_{{$i}}" name="branch[]" value="branch_edit"
													@if(!empty($regex->branch_edit))
													@if($regex->branch_edit == TRUE) {{'checked'}} @endif
													@endif
													>
												</td>
												<td>
													<input type="checkbox" class="branch_{{$i}}" name="branch[]" value="branch_delete"
													@if(!empty($regex->branch_delete))
													@if($regex->branch_delete == TRUE) {{'checked'}} @endif
													@endif
													>
												</td>
												<td>
										...
										<!-- Branch Admin Access Rights Start -->
											<tr>
												<td>{{ trans('app.Branch Admin')}}</td>
												<td class="">
													<input type="checkbox" data-row="{{$i}}" class="main_access" data-for="branchAdmin" name="branchAdmin[]" value="branchAdmin_view"
													@if(!empty($regex->branchAdmin_view))
													@if($regex->branchAdmin_view == TRUE) {{'checked'}} @endif
													@endif
													>
												</td>
												<td>
													<input type="checkbox" class="branchAdmin_{{$i}}" name="branchAdmin[]" value="branchAdmin_add"
													@if(!empty($regex->branchAdmin_add))
													@if($regex->branchAdmin_add == TRUE) {{'checked'}} @endif
													@endif
													>
												</td>
												<td>
													<input type="checkbox" class="branchAdmin_{{$i}}" name="branchAdmin[]" value="branchAdmin_edit"
													@if(!empty($regex->branchAdmin_edit))
													@if($regex->branchAdmin_edit == TRUE) {{'checked'}} @endif
													@endif
													>
												</td>
												<td>
													<input type="checkbox" class="branchAdmin_{{$i}}" name="branchAdmin[]" value="branchAdmin_delete"
													@if(!empty($regex->branchAdmin_delete))
													@if($regex->branchAdmin_delete == TRUE) {{'checked'}} @endif
													@endif
													>
												</td>
												<td>
													@if($get_right->role_name == "Branch Admin")
													<input type="checkbox" class="branchAdmin_{{$i}}" name="branchAdmin[]" value="branchAdmin_owndata"
													@if(!empty($regex->branchAdmin_owndata))
													@if($regex->branchAdmin_owndata == TRUE) {{'checked'}} @endif
													@endif
													>
													@endif
												</td>
										...
										<!-- Branch Setting Module Access Rights Start -->
											<tr>
												<td>{{ trans('app.Branch Setting')}}</td>
												<td class="">
													<input type="checkbox" data-row="{{$i}}" class="main_access" data-for="branchsetting" name="branchsetting[]" value="branchsetting_view"
													@if(!empty($regex->branchsetting_view))
													@if($regex->branchsetting_view == TRUE) {{'checked'}} @endif
													@endif
													>
												</td>
												<td>
													<input type="checkbox" class="branchsetting_{{$i}}" name="branchsetting[]" value="branchsetting_edit"
													@if(!empty($regex->branchsetting_edit))
													@if($regex->branchsetting_edit == TRUE) {{'checked'}} @endif
													@endif
													>
												</td>
												<td>
