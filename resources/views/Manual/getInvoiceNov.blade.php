				  				...
				  				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										<label class="control-label col-md-4 col-sm-4 col-xs-12" for="Date">
											Job Open Date <label class="color-danger">*</label></label>
							
										<div class="col-md-8 col-sm-8 col-xs-12 input-group date datepicker" >
											<span class="input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
											<input type="text"  name="job_open_date" autocomplete="off" id="date_of_birth" class="form-control job_open_date" placeholder="<?php echo getDatepicker();?>" onkeypress="return false;" required >
										</div>
				  					</div>
					 				...
					 				<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12 input-group date datepicker" >
											<span class="input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
											<input type="text"  name="delivery_date" autocomplete="off" id="date_of_birth" class="form-control delivery_date" placeholder="<?php echo getDatepicker();?>" onkeypress="return false;" required >
										</div>
				  					</div>			 				
				  				</div>
				  				<?php /*##################*/?>
								...
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">   
								  	<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv">
			                        	<label class="control-label col-md-4 col-sm-4 col-xs-12" for="cus_name">
			                        		CUSTOMET VAT <label class="color-danger">*</label></label>			
			                        	<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" name="customer_vat" class="form-control customer_vat">
			                        	</div>
			                      	</div>
			                    
								  	<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
			                        	<label class="control-label col-md-4 col-sm-4 col-xs-12" for="cus_name">
			                        		VAT NUMBER <label class="color-danger">*</label></label>						
				                        <div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text"  id="vat_number" name="vat_number"  value= "{{$auth_branch_vat_number}}" class="form-control">
				                        </div>
			                      	</div>
								</div>
			                </div>
