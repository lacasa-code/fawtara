								...
								<div class="col-md-12 col-sm-12 col-xs-12">
								  	<div class="col-md-6 col-sm-6 col-xs-12 my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" name="Invoice_type" class="form-control" value="0" disabled="disabled">
										</div>
								  	</div>
								</div>
							</div> -->
...
<?php /* */ ?>
                				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
			                        ...
			                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="cus_name">
			                        	...
			                        	<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text"  id="vat_number" name="vat_number"  value= "{{$invoice->vat_number}}" class="form-control" readonly>
			                        	</div>
			                      	</div>
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv">
			                        	...
			                        	<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" name="branch_name" class="form-control" value="{{ $invoice->branch_name }}" readonly>
			                        	</div>
			                      	</div> 
                				</div> 
<?php /* */ ?>	
...
<?php /* */ ?>
                				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group {{$errors->has('customer_address') ? 'error' : null}}">
										<label class="control-label col-md-4 col-sm-4 col-xs-12" for="cus_name">
                        ...
                        @endif
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv {{$errors->has('customer_vat') ? 'error' : null}}">
			                        	...
			                        	<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" name="customer_vat" value="{{ $invoice->customer_vat }}" class="form-control customer_vat">
...
<?php /* */ ?>
                				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group {{$errors->has('customer_phone') ? 'error' : null}}">
										<label class="control-label col-md-4 col-sm-4 col-xs-12" for="cus_name">
                        ...
                        @endif
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group {{$errors->has('customer_po_number') ? 'error' : null}}">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" name="customer_po_number" value="{{ $invoice->customer_po_number }}" class="form-control">
...
<?php /* */ ?>								
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group {{$errors->has('Job_card') ? 'error' : null}}">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" name="Job_card" value="{{ $invoice->Job_card }}" class="form-control">
											@if($errors->has('Job_card'))
                        <span class="help-block" style="color:red;">{{$errors->first('Job_card')}}</span>
                        @endif
										</div>
									</div>

									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group {{$errors->has('quotation_number') ? 'error' : null}}">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" name="quotation_number" value="{{ $invoice->quotation_number }}" class="form-control">
...
<?php /* */ ?>
                				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group {{$errors->has('meters_reading') ? 'error' : null}}">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" name="meters_reading" value="{{ $invoice->meters_reading }}" class="form-control">
...
<?php /* */ ?>						
								...
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group {{$errors->has('delivery_date') ? 'error' : null}}">
										...
										<div class="col-md-8 col-sm-8 col-xs-12 input-group date datepicker" >
											...
											<input type="text"  name="Date" autocomplete="off" id="date_of_birth" class="form-control invoiceDate" placeholder="<?php echo getDatepicker();?>" onkeypress="return false;" value="{{ $invoice->Date }}" required >
										</div>
				  					</div>
					 				...
					 				<div class="col-md-6 col-sm-6 col-xs-12 form-group {{$errors->has('Discount') ? 'error' : null}}">
                    					...
                    					<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" maxlength="3"  name="Discount" value="{{ $invoice->Discount }}" class="form-control discount" id="disc">
                        ...
                        @endif
				  				...
				  				<?php /*##################*/ ?>
				  				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group {{$errors->has('job_open_date') ? 'error' : null}}">
										...
										<div class="col-md-8 col-sm-8 col-xs-12 input-group date datepicker" >
											<span class="input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
											<input type="text"  name="job_open_date" autocomplete="off" id="date_of_birth" class="form-control job_open_date" placeholder="<?php echo getDatepicker();?>" onkeypress="return false;" value="{{ $invoice->job_open_date }}" required >
										</div>
                        ...
                        @endif
					 				...
					 				<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12 input-group date datepicker {{$errors->has('delivery_date') ? 'error' : null}}">
											<span class="input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
											<input type="text"  name="delivery_date" autocomplete="off" id="date_of_birth" class="form-control delivery_date" placeholder="<?php echo getDatepicker();?>" onkeypress="return false;" value="{{ $invoice->delivery_date }}" required >
										</div>
...
<?php /* */ ?>
                				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
								<textarea name="Details" class="form-control">{{ $invoice->Details }}</textarea>
										</div>
									</div>
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group paymentTypeMainDiv">
                    					...
                    					<div class="col-md-8 col-sm-8 col-xs-12">
											...
											@if(!empty($tbl_payments))
												...
												<option value="{{$tbl_paymentss->id}}" {{ $tbl_paymentss->id == $invoice->Payment_type ? 'selected' : '' }} >{{ $tbl_paymentss->payment }}</option>
												@endforeach
											@endif
											</select>
                    					</div>
...
<?php /* */ ?>
                				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group{{$errors->has('service_name.0') ? 'error' : null}}">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text"  id="service_name" name="service_name[]" value="{{$services[0]->service_name}}" class="form-control">
                        ...
                        @endif 	
									...
									<div class="col-md-3 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv {{$errors->has('service_value.0') ? 'error' : null}}">
			                        	...
			                        	<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text"  id="service_value" name="service_value[]" value="{{$services[0]->service_value}}" class="form-control">
                        ...
                        @endif 	
			                      	...
			                      	<div class="col-md-3 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv {{$errors->has('qty.0') ? 'error' : null}}">
			                        	<label class="control-label col-md-4 col-sm-4 col-xs-12" for="cus_name">
			                        	   ...
			                        	   <div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text"  id="qty" name="qty[]" value="{{$services[0]->qty}}" class="form-control">
											@if($errors->has('qty.0'))
                				...
                				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											...
											@if(count($services) > 1)
											<input type="text"  id="service_name" name="service_name[]" value="{{$services[1]->service_name}}" class="form-control">
									...
									<div class="col-md-3 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv {{$errors->has('service_value.0') ? 'error' : null}}">
			                        	...
			                        	<div class="col-md-8 col-sm-8 col-xs-12">
											...
											@if(count($services) > 1)
											<input type="text"  id="service_value" name="service_value[]" value="{{$services[1]->service_value}}" class="form-control">
											
											@else
											<input type="text"  id="service_value" name="service_value[]" class="form-control">
			                      	...
			                      	<div class="col-md-3 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv">
			                        	<label class="control-label col-md-4 col-sm-4 col-xs-12" for="cus_name">
			                        	   ...
			                        	   <div class="col-md-8 col-sm-8 col-xs-12">
			                        	   @if(count($services) > 1)
											<input type="text"  id="qty" name="qty[]" value="{{$services[1]->qty}}" class="form-control">
                				...
                				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											...
											@if(count($services) > 2 )
											<input type="text"  id="service_name" name="service_name[]" value="{{ $services[2]->service_name }}" class="form-control">
									...
									<div class="col-md-3 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv {{$errors->has('service_value.2') ? 'error' : null}}">
			                        	<label class="control-label col-md-4 col-sm-4 col-xs-12" for="cus_name">
			                        	    Value:  <br> قيمة الخدمة<label class="color-danger">*</label></label>			
			                        	<div class="col-md-8 col-sm-8 col-xs-12">

			                        		@if(count($services) > 2 )
											<input type="text"  id="service_value" name="service_value[]" value="{{ $services[2]->service_value }}" class="form-control">
			                      	...
			                      	<div class="col-md-3 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv {{$errors->has('qty.4') ? 'error' : null}}">
			                        	<label class="control-label col-md-4 col-sm-4 col-xs-12" for="cus_name">
			                        	   ...
			                        	   <div class="col-md-8 col-sm-8 col-xs-12">
			                        	   @if(count($services) > 2)
											<input type="text"  id="qty" name="qty[]" value="{{$services[2]->qty}}" class="form-control">
                				...
                				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											...
											@if(count($services) > 3 )
											<input type="text"  id="service_name" name="service_name[]" value="{{ $services[3]->service_name }}" class="form-control">
									...
									<div class="col-md-3 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv">
			                        	...
			                        	<div class="col-md-8 col-sm-8 col-xs-12">
			                        		...
			                        		@if(count($services) > 3 )
											<input type="text"  id="service_value" name="service_value[]" value="{{ $services[3]->service_value }}" class="form-control">
			                      	...
			                      	<div class="col-md-3 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv {{$errors->has('qty.4') ? 'error' : null}}">
			                        	<label class="control-label col-md-4 col-sm-4 col-xs-12" for="cus_name">
			                        	   ...
			                        	   <div class="col-md-8 col-sm-8 col-xs-12">
			                        	   @if(count($services) > 3)
											<input type="text"  id="qty" name="qty[]" value="{{$services[3]->qty}}" class="form-control">
                				...
                				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											...
											@if(count($services) > 4 )
											<input type="text"  id="service_name" name="service_name[]" value="{{ $services[4]->service_name }}" class="form-control">
									...
									<div class="col-md-3 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv">
			                        	...
			                        	<div class="col-md-8 col-sm-8 col-xs-12">
			                        		...
			                        		@if(count($services) > 4 )
											<input type="text"  id="service_value" name="service_value[]" value="{{ $services[4]->service_value }}" class="form-control">
			                      	...
			                      	<div class="col-md-3 col-sm-6 col-xs-12 form-group my-form-group paidAmountMainDiv {{$errors->has('qty.4') ? 'error' : null}}">
			                        	<label class="control-label col-md-4 col-sm-4 col-xs-12" for="cus_name">
			                        	   ...
			                        	   <div class="col-md-8 col-sm-8 col-xs-12">
			                        	   @if(count($services) > 4)
											<input type="text"  id="qty" name="qty[]" value="{{$services[4]->qty}}" class="form-control">
