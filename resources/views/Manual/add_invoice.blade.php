            		...
            		<div id="form_fields">
						<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12 ">
											<?php /* <input class="form-control" type="text" name="customer_name" value="{{getCustomerName($service->customer_id)}}">  */ ?>
                		...
                		<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" name="quotaion_no" class="form-control">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12 ">
											<input class="form-control" type="text" name="customer_po_no">
										</div>
									</div>
                		</div>
                		<?php  /*#################*/ ?>
                		...
                		<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="date" class="form-control" name="job_open_date" class="form-control"></div>
									</div>
                		...
                		<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12 ">
											<input class="form-control" type="text" name="meteres_reading">
										</div>
									</div>
                		</div>
                		<?php  /*#################*/ ?>
                		...
                		<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12 ">
											<input class="form-control" type="text" name="registeration">
										</div>
									</div>
                		</div>
                		<?php  /*#################*/ ?>
                		...
                		<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12 ">
											<input class="form-control" type="text" name="paid_amount">
										</div>
									</div>
