							...
							<form id="employee_edit_form" method="post" action="update/{{ $user->id }}" enctype="multipart/form-data" class="form-horizontal upperform">
								...
								<div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback ">
                                        ...
                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                            <input type="text" id="employeeid" name="employeeid"   placeholder="{{ trans('app.Enter Employee ID')}}" class="form-control" value="{{ $user->employeeid }}" maxlength="16" minlength="6">
                                        </div>
                                    </div>
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback">
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
										  <select class="form-control col-md-7 col-xs-12 select_branch" name="branch">
												...
												<option value="{{ $branchData->id }}" <?php if($user->branch_id==$branchData->id){ echo "selected"; }?>>{{$branchData->branch_name }}</option>
												@endforeach
										  </select>
										</div>
									</div>
							...
							<!-- custom field -->
								...
								<div class="form-group col-md-12 col-sm-12 col-xs-12">
									<div class="col-md-12 col-sm-12 col-xs-12 text-center">
										...
										<button type="submit" class="btn btn-success updateEmployeeButton">{{ trans('app.Update')}}</button>
									</div>
								</div>
							</form>
						</div>
	...
	$('body').on('click','.updateEmployeeButton',function(e){
		$('#employee_edit_form input, #employee_edit_form select, #employee_edit_form textarea').each(
		    ...
		    function(index)
		    {
		        ...
		        if (input.attr('name') == "firstname" || input.attr('name') == "lastname" || input.attr('name') == "email"  || input.attr('name') == "password" || input.attr('name') == "password_confirmation" || input.attr('name') == "mobile" || input.attr('name') == "join_date" || input.attr('name') == "designation" || input.attr('name') == "country_id" || input.attr('name') == "address") {
		        	if (input.val() == "") {
		        		return true;
		        	}
		        	else{
