						...
						<form id="vehicleAdd-Form" action="{{ url('/vehicle/store') }}" method="post" enctype="multipart/form-data"  class="form-horizontal upperform vehicleAddForm">
							...
							<div class="form-group" style="margin-top:20px;">
								<div class="my-form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">{{ trans('app.Customer')}} <label class="color-danger">*</label></label>
							...
							<div class="form-group">
								...
								<div class="{{ $errors->has('price') ? ' has-error' : '' }} my-form-group">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<input type="text"  name="price"  value="{{ old('price') }}" placeholder="{{ trans('app.Enter Price')}}" class="form-control price_is" maxlength="10" >
										<!-- @if ($errors->has('price'))
	...
	$('body').on('click','.vehicleAddSubmitButton',function(e){
		$('#vehicleAdd-Form input, #vehicleAdd-Form select, #vehicleAdd-Form textarea').each(
		    ...
		    function(index)
		    {
		        ...
		        if (input.attr('name') == "customer_id" || input.attr('name') == "vehical_id" || input.attr('name') == "vehicabrand" || input.attr('name') == "fueltype" || input.attr('name') == "modelname"  || input.attr('name') == "price") {
		        	if (input.val() == "")
		        	{
		        		return false;
		        	}
