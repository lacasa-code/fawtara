						...
						<form id="vehicleEdit-Form"  action="update/{{$vehicaledit->id }}" method="post" enctype="multipart/form-data"  class="form-horizontal upperform">
	                              	...
	                              	<div class="col-md-4 col-sm-4 col-xs-12">
	                                	<select class="form-control  select_branch" name="branch">
	                                  	@foreach ($branchDatas as $branchData)
											<option value="{{ $branchData->id }}" <?php if($vehicaledit->branch_id==$branchData->id){ echo "selected"; }?>>{{$branchData->branch_name }}</option>
										@endforeach
	                                	</select>
	                              	</div>
	                            </div>
                            ...
                            <div class="form-group">
                                <div class="">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <input type="file" id="License" name="License" value="{{$vehicaledit->license}}" class="form-control chooseLicense">
                                        <img src="{{ URL::asset('public/vehicle/'.$vehicaledit->license) }}"  width="100px" height="60px" >
				...
				<!-- Custom Filed data value End-->
							...
							<div class="form-group col-md-12 col-sm-12 col-xs-12">
								<div class="col-md-12 col-sm-12 col-xs-12 text-center">
									...
									<button type="submit" class="btn btn-success updateVehicleButton">{{ trans('app.Update')}}</button>
								</div>
							</div>
						</form>
					</div>
