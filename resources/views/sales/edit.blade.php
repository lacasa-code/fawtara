							...
							<!-- Custom Filed data value End-->
								...
								<div class="form-group">
									<div class="col-md-12 col-sm-12 col-xs-12 text-center">
									  ...
									  <button type="submit" class="btn btn-success updateVehicleSaleButton">{{ trans('app.Update')}}</button>
									</div>
								</div>
							</form>
						</div>
...
$(document).ready(function()
{
	...
	$('.veh_brand').change(function(){
		...
		var msg13 = "{{ trans('app.Somthing went wrong')}}";
		$.ajax({
			type : 'GET',
			url : url,
	...
	$("#no_of_service").change(function(){
		...
		var msg21 = "{{ trans('app.Interval')}}";
		var msg22 = "{{ trans('app.Please select interval!')}}";
	...
	$('.addcolor').click(function(){
		...
		var msg24 = "{{ trans('app.Please enter color name')}}";
		var msg25 = "{{ trans('app.This Record is Duplicate')}}";
		var msg26 = "{{ trans('app.An error occurred :')}}";
	...
	$('body').on('click','.updateVehicleSaleButton',function(e){
		$('#vehicleSalesEditForm input, #vehicleSalesEditForm select, #vehicleSalesEditForm textarea').each(
