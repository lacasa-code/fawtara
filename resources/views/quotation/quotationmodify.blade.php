   ...
   <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
         <div class="x_panel">
            ...
            <form method="post" action="{!! url('/quotation/add_modify_quotation') !!}" class="addJobcardForm" enctype="multipart/form-data">
                ...
                @endif
                     ...
                     @if($washbayPrice != null)
                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:5px;">
                           ...
                           <div class="col-md-4 col-sm-4 col-xs-12">
                              <input type="text" id="washBay" name="washBayCharge" class="form-control" value="{{ $washbayPrice }}" readonly>
                           </div>
                        </div>
                     @endif

                          <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:5px;">
                              <label class="col-md-2 col-sm-2 col-xs-12">{{ trans('app.Fix Service Charge')}}<label class="text-danger"></label>:</label>
                              <div class="col-md-4 col-sm-4 col-xs-12">
                                  <input type="text" id="washBay" name="charge" class="form-control" value="{{ $service_data->charge }}" readonly>
                              </div>
                          </div>
                      <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:5px;">
                          <label class="col-md-2 col-sm-2 col-xs-12">{{ trans('app.Details')}}<label class="text-danger"></label>:</label>
                          <div class="col-md-4 col-sm-4 col-xs-12">
                              <input type="text" id="washBay" name="charge" class="form-control" value="{{ $service_data->detail }}" readonly>
                          </div>
                      </div>
                   ...
                   <div class="my-form-group">
                       ...
                       <div class="col-md-4 col-sm-4 col-xs-12">
                           <select id="assignestaff" name="assignestaff"  class="form-control" required>
                               <option value="">-- {{ trans('app.Select Assign To')}} --</option>
                               @if(!empty($employee))
                                   @foreach($employee as $employees)
                                       <option value="{{ $employees->id }}" <?php if($employees->id==$service_data->assign_staff){ echo"selected";}?>> {{ $employees->name }}</option>
                                   @endforeach
                               @endif
                           </select>
                       </div>
