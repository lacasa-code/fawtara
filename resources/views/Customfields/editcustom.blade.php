								...
								<div class="form-group has-feedback my-form-group">
									...
									<div class="col-md-5 col-sm-5 col-xs-12">
										<select class="form-control col-md-9 col-xs-12 select_form_name" id="select_form_name" name="formname" disabled="">
											...
											<option value="branch_admin"<?php if($tbl_custom_fields->form_name == 'branch_admin'){echo "selected";}?>>{{ trans('app.Branch Admin')}}</option>
...
$(document).ready(function()
{
	...
	$('body').on('click','.add_more_radio',function(){
		...
		var msg1 = "{{ trans('app.Duplicate data are not allowed')}}";
		var msg2 = "{{ trans('app.Enter radio label name')}}";
	...
	$('body').on('click','.add_more_checkbox',function(){
		...
		var msg3 = "{{ trans('app.Duplicate data are not allowed')}}";
		var msg4 = "{{ trans('app.Enter radio label name')}}";
	...
	$('body').on('click','.updateButton',function(e){
		...
		var msg5 = "{{ trans('app.Please enter radio label name on textbox after click on Add button.')}}";
		var msg6 = "{{ trans('app.Please enter checkbox label name on textbox after click on Add button.')}}";
	...
	$('body').on('keyup', '.r_label_inputbox', function(){
      	...
      	var msg7 = "{{ trans('app.At first position only alphabets are allowed.')}}";
		var msg8 = "{{ trans('app.Special symbols are not allowed.')}}";

      	if (!inputText.replace(/\s/g, '').length) {
         	$(this).val("");
      	}
      	else if(!inputText.match(/^[a-zA-Z\u0621-\u064A\u00C0-\u017F\u0600-\u06FF\u0750-\u077F\uFB50-\uFDFF\uFE70-\uFEFF\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD\u0900-\u097F][a-zA-Z0-9\u0621-\u064A\u00C0-\u017F\u0600-\u06FF\u0750-\u077F\uFB50-\uFDFF\uFE70-\uFEFF\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD\u0900-\u097F\s\.\-\_]*$/)){
	...
	/*checkbox label add time check for special symbols*/
   	$('body').on('keyup', '.c_label_inputbox', function(){
      	...
      	var msg9 = "{{ trans('app.At first position only alphabets are allowed.')}}";
		var msg10 = "{{ trans('app.Special symbols are not allowed.')}}";
