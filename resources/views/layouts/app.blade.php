				 			...
				 			@if(!empty(Auth::user()->id))
								...
								@endif
                                    @if(Auth::user()->role=='engineer')
                                        <a href="{!! url('/engineer/profile')!!}"><img src="{{ URL::asset('public/engineer/'.Auth::user()->image)}}" alt="..." class="img-circle profile_img"></a>
                                    @endif

								@if(Auth::user()->role=='branch_admin')
									<a href="{!! url('/setting/profile')!!}"><img src="{{ URL::asset('public/branch_admin/'.Auth::user()->image)}}" alt="..." class="img-circle profile_img"></a>
								@endif
							@endif
              			</div>
            		...
            		<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              			<div class="menu_section">
                			<ul class="nav side-menu">
			                	...
			                	@canany(['customer_view','employee_view','engineer_view','supportstaff_view','accountant_view','branchAdmin_view'])
				                    ...
				                    <ul class="nav child_menu">
										@can('customer_view')
									 	...
									 	@can('employee_view')
				                      	...
				                      	@endcan
                                        @can('engineer_view')
                                            <li><a href="{!! url('/engineer/list')!!}">{{ trans('app.engineers')}}</a></li>
                                         @endcan
			                 ...
			                 <!--  		<li><a href="{!! url('/service/list') !!}"><i class="fa fa-slack image_icon"></i>{{ trans('app.Services')}}</a></li> -->
                               ...
                               @can('reportcar_view')
                                <!--     <li><a href="{!! url('/reportcar/list') !!}"><i class="fa fa-slack image_icon"></i>{{ trans('app.reportcar')}}</a></li> -->
                               @endcan 
								...
								@can('invoice_view')
			                  		<li><a href="{!! url('/invoice/listall') !!}" ><i class="fa fa-file-text-o"></i>
			                  		 Pending Invoices </a></li>
								@endcan
