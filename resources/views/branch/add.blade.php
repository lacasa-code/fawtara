    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					<div class="x_content">
						<form id="branchAddForm" method="post" action="{!! url('branch/store') !!}" enctype="multipart/form-data"  class="form-horizontal upperform branchAddForm">
							...
							<div class="col-md-12 col-sm-6 col-xs-12">  
								<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
									  <input type="text" id="branchname" name="branchname" value="{{ old('branchname') }}"  placeholder="{{ trans('app.Enter branch name')}}" class="form-control branchname" maxlength="50">
									</div>
								</div>								
							   	...
							   	<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
									  <input type="text" id="contactnumber" name="contactnumber"  value="{{ old('contactnumber') }}" placeholder="{{ trans('app.Enter contact number')}}" class="form-control contactnumber" maxlength="16" minlength="6">
									</div>
								</div>
							</div>
							...
							<div class="col-md-12 col-sm-6 col-xs-12">  
								<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
									  <input type="text" id="email" name="email" value="{{ old('email') }}"  placeholder="{{ trans('app.Enter email')}}" class="form-control email" maxlength="50">
									</div>
								</div>								
							   	...
							   	<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										...
										<img src="#" id="imagePreview" alt="Branch Image" class="imageHideShow" style="width: 20%; display: none; padding-top: 8px;">
									</div>
								</div>							   	
							</div>
							...
							<div class="col-md-12 col-sm-6 col-xs-12">
								...
								<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
									  <input type="text" id="address" name="address"  value="{{ old('address') }}" placeholder="{{ trans('app.Enter address')}}" class="form-control address" maxlength="50">
									</div>
								</div>
							</div>
						...
						<!-- Custom field -->
							...
							<div class="form-group col-md-12 col-sm-12 col-xs-12">
								<div class="col-md-12 col-sm-12 col-xs-12 text-center">
									...
									<button type="submit" class="btn btn-success branchSubmitButton">{{ trans('app.Submit')}}</button>
								</div>
							</div>
						</form>
					</div>
