          ...
          <div>
            ...
            <!-- Washbay Service Charge Details Start -->
               ...
               ?>
                  <table class="table table-bordered" border="1" style="border-collapse:collapse;">
                     <tr class="printimg">
                        <td class="cname"><b>{{ trans('app.WASH BAY SERVICE CHARGE') }}</b></td>
                     </tr>
                  </table>
                  <table class="table table-bordered adddatatable" border="1" style="border-collapse:collapse;">
                     <thead>
                     ...
                     <tbody>
                        <tr>
                           <td class="text-center cname">1</td>
                           <td class="text-center cname">{{ trans('app.Wash Bay Service') }}</td>
            ...
            <!-- For Custom Field End -->
                  ...
                  <table class="table table-bordered" style="border-collapse:collapse;">
                     ...
                     <tr>
                        ...
                        <td class="text-center cname" ><b><?php $total_amt = $total1 + $total2 + $total3 + $total4 + $fix; echo number_format($total_amt, 2);  ?></b></td>
                     </tr>
                     <tr>
