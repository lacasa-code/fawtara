               		...
               		<div class="x_content">
                		<form method="post" id="form_add" action="{{ url('/invoiceStore') }}" enctype="multipart/form-data"  name="Form" class="form-horizontal upperform saleAddForm" >
							...
							<input type="text" name="quotation_no" class="form-control">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
                    					<label class="control-label col-md-4 col-sm-4 col-xs-12 currency" for="cus_name"> CUSTOMER P.O NO:
								...
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										<label class="control-label col-md-4 col-sm-4 col-xs-12" for="Date">
											{{ trans('app.Invoice Date')}} <label class="color-danger">*</label></label>
				  				...
				  				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
										...
										<div class="col-md-8 col-sm-8 col-xs-12 input-group date datepicker" >
											<span class="input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
											<input type="text"  name="job_open_date" autocomplete="off" id="date_of_birth" class="form-control invoiceDate" placeholder="<?php echo getDatepicker();?>" onkeypress="return false;" required >
										</div>
				  					</div>
					 				...
					 				<div class="col-md-6 col-sm-6 col-xs-12 form-group">
                    					...
                    					<div class="col-md-8 col-sm-8 col-xs-12 input-group date datepicker" >
											<span class="input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
											<input type="text"  name="delivery_date" autocomplete="off" id="date_of_birth" class="form-control invoiceDate" placeholder="<?php echo getDatepicker();?>" onkeypress="return false;" required >
										</div>
                  					</div>					 				
				  				</div>
							...
							<input type="text" name="quotation_no" class="form-control">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
                    					<label class="control-label col-md-4 col-sm-4 col-xs-12 currency" for="cus_name"> METERS READING (HAS/KM):
                    					  <label class="color-danger">*</label></label>						
							...
							<input type="text" name="quotation_no" class="form-control">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
                    					<label class="control-label col-md-4 col-sm-4 col-xs-12 currency" for="cus_name"> REGISTRATION:
                    					  <label class="color-danger">*</label></label>						
							...
							<input type="text" name="quotation_no" class="form-control">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
                    					<label class="control-label col-md-4 col-sm-4 col-xs-12 currency" for="cus_name"> SERIAL NO:
                    					  <label class="color-danger">*</label></label>						
							...
							<input type="text" name="quotation_no" class="form-control">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
                    					<label class="control-label col-md-4 col-sm-4 col-xs-12 currency" for="cus_name"> 
                    					  <label class="color-danger"></label></label>						
                    					
                    					<div class="col-md-8 col-sm-8 col-xs-12 ">
                    					<?php //	<input type="text" name="customer_po_no" class="form-control"> ?>
										</div>
									</div>				  					
			    				</div>
			    				<?php // ?>
