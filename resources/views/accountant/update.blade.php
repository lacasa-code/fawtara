				...
				<div class="nav_menu">
					<nav>
						<div class="nav toggle">
							<a id="menu_toggle"><i class="fa fa-bars"></i><span class="titleup">&nbsp; {{ trans('app.Accountant')}}</span></a>
						</div>
							...
							<div class="col-md-12 col-sm-6 col-xs-12">
                        			...
                        			<div class="col-md-8 col-sm-8 col-xs-12">
                          				<select class="form-control col-md-7 col-xs-12 select_branch" name="branch">
                            				@foreach ($branchDatas as $branchData)
                              					<option value="{{ $branchData->id }}" <?php if($accountant->branch_id==$branchData->id){ echo "selected"; }?>>{{$branchData->branch_name }}</option>
                            				@endforeach
                          				</select>
                        			</div>
                      			</div>
                                ...
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group {{ $errors->has('join_date') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8 col-sm-8 col-xs-12 input-group date datepicker">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                            <input type="text" id="join_date" class="form-control leftdate joinDate" placeholder="<?php echo getDatepicker();?>"  value="{{date(getDateFormat(),strtotime($accountant->join_date))}}"   name="join_date" readonly>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group my-form-group has-feedback {{ $errors->has('employeeid') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                            <input type="text" id="employeeid" name="employeeid"  value="{{$accountant->employeeid }}" placeholder="{{ trans('app.Enter Employee ID')}}" class="form-control"  maxlength="16" minlength="6">
							...
							<!-- Custom field  -->
	                      	...
	                      	<div class="form-group col-md-12 col-sm-12 col-xs-12">
	                        	<div class="col-md-12 col-sm-12 col-xs-12 text-center">
	                          		...
	                          		<button type="submit" class="btn btn-success updateAccountantButton">{{ trans('app.Update') }}</button>
	                        	</div>
	                      	</div>
                    	</form>
                	</div>
...
$(document).ready(function()
{
	...
	$('body').on('click','.updateAccountantButton',function(e){
		$('#accountant_edit_form input, #accountant_edit_form select, #accountant_edit_form textarea').each(
