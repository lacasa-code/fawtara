	   ...
	   <div class="items">
		  ...
		  <div class="col-md-12 col-sm-12 col-xs-12 form-group  form_group_error">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
					...
					<span id="checkpoints_edit_error" class="help-block error-help-block color-danger" style="display: none">{{ trans('app.Start should be alphabets only after supports alphanumeric, space, dot, @, _, and - are allowed.')}}</span>

					<span id="checkpoints_edit_error1" class="help-block error-help-block color-danger" style="display: none">{{ trans('app.field is required')}}</span>
				</div>
		  </div>
	  	</div>
	<?php } ?>
