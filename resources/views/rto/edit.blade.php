	                              	...
	                              	<div class="col-md-5 col-sm-5 col-xs-12">
	                                	<select class="form-control  select_branch" name="branch">
	                                  	@foreach ($branchDatas as $branchData)
											<option value="{{ $branchData->id }}" <?php if($rto->branch_id==$branchData->id){ echo "selected"; }?>>{{$branchData->branch_name }}</option>
										@endforeach
	                                	</select>
	                              	</div>
	                            </div>
						...
						<!-- Custom Filed data value End-->
								...
								<div class="form-group col-md-12 col-sm-12 col-xs-12 ">
									<div class="col-md-9 col-sm-9 col-xs-12 text-center">
									  ...
									  <button type="submit" class="btn btn-success updateRtoButton">{{ trans('app.Update')}}</button>
									</div>
								</div>
							</form>
